package luan.melo.conqueuer.front.storage.impl;

import luan.melo.conqueuer.front.domain.Execucao;
import luan.melo.conqueuer.front.storage.gcloud.FilePointerHandler;
import luan.melo.conqueuer.front.storage.gcloud.GCloudStorage;
